  ...
  <div class="col-md-6">
    <div class="card border-0 shadow-sm">
      <div class="card-header bg-white fw-bold">
        <i class="bi bi-person-plus me-2 text-primary"></i>เพิ่มสมาชิกใหม่
      </div>
      <div class="card-body">
        ...
        <form method="post" action="<?= site_url('/members/store') ?>">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="phone" class="form-control"
                   value="<?= old('phone') ?>" placeholder="0812345678" required>
          </div>

          <div class="mb-3">
            <label class="form-label fw-semibold">ที่อยู่</label>
            <textarea name="address" class="form-control" rows="3"
                      placeholder="บ้านเลขที่ ถนน ตำบล อำเภอ จังหวัด"><?= old('address') ?></textarea>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" name="tax_id" class="form-control"
                   value="<?= old('tax_id') ?>" placeholder="0-0000-00000-00-0" maxlength="20">
